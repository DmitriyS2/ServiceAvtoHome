...
namespace ServiceAvtoHome
{
    ...
    {
        public static string? user, searchMarka, searchColor, newTypeDisk, newTypeTyre, newConditioner, newHeat, newNavigation, choiseYN, newLineParametr;
        public static int choice, nomerAvto, counterCustomerAvto, yearEditionA, yearEditionB, powerA, powerB, tempIndex, newRadius, addCost, newNumberParametr;
